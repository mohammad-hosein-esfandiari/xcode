...
const Pricing = () => {
  ...
  return (
    ...
    <ul className=" xl:container mb-4 lg:px-[100px] h-screen ss:px-8 px-2 bg-linear1 flex flex-col items-center justify-between py-16  ">
      <li className="text-mode-color z-10"><h2 className="bg-mode-color rounded-lg py-2 px-4">Shopping cart</h2></li>
      <li className=" ss:px-20  md:px-44 xs:px-4 px-2 w-full flex-1 -mt-4">
        <ItemHolder />
      </li>
