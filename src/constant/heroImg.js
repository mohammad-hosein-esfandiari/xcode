...
export const heroImg = [
    {
        ...
        right-[50px]
        md:top-[240px] md:right-[200px]  md:w-[350px] md:h-[350px]
        lg:right-[200px] lg:top-[280px]  lg:w-[400px] lg:h-[400px]  
        sm:w-[75%] sm:top-[155px]  md:right-[200px]
    ...
    },
    {
        ...
        boxDelay:2,
        Imgdelay: 2,
        className: ` shadow-boxShadow absolute border-[15px] rounded-full border-color-border1 right-[50px] hidden  
        md:w-[190px] md:h-[180px] md:top-[225px] md:right-[100px] md:block
        lg:w-[211px] lg:h-[200px] lg:top-[295px] lg:right-[80px]
    ...
    },
    {
        ...
        md:w-[120px]  md:h-[120px] md:top-[110px] md:right-[260px] md:block
        lg:w-[140px]  lg:h-[140px] lg:right-[280px] lg:top-[120px]
        hlg:w-[150px] hlg:h-[150px] hlg:top-[100px]
        rounded-full  right-[280px] top-[130px] `,
