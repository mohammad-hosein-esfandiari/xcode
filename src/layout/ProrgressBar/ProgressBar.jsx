      ...
      <AnimatePresence>
        {showProgress && (
          <motion.a
            ...
            <div className=" border-[3px] border-primary w-[99%] h-[99%] flex items-center justify-center  rounded-full absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]  opacity-25"></div>
