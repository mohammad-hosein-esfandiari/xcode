  ...
  return (
    <div className=" overflow-hidden xs:w-[160px] xs:h-[160px] w-[100px] h-[100px] z-10   absolute xs:top-[-183px] top-[-162px] rounded-full left-[50%] translate-x-[-50%]">
      <div className="w-full h-full z-10 relative">
        {loading && (
          <div className=" absolute z-20 top-0 right-0 w-full h-full flex items-center justify-center bg-[#09090937]">
        ...
        <Image
          src={
            !isUserLoggedIn ? unknown : image === "image.png" ? unknown : image
          }
          width={500}
          height={500}
          priority={true}
          ...
          className={`w-full ${
            loading && "blur-sm"
          } peer-hover:blur-sm h-full object-center object-cover`}
        />
