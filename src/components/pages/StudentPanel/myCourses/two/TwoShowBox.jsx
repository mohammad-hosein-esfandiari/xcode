...
const TwoShowBox = ({
  ...
  return (
    <Link
      href={`/courses/${_id}`}
      className="bg-linear5 text-mode-color relative transition-all duration-300 cursor-pointer hover:scale-[1.01] shadow-modeShadow rounded-lg md:p-6 p-4 flex flex-col justify-between  ">
      ...
      <div>
        <FirstRow
          ...
          image={image}
        />
        <h3 className="ss:py-4 py-2  sm:text-[18px] ">{title}</h3>
