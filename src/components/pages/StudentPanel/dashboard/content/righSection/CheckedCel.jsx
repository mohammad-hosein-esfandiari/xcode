const CheckedCel = ({num,datBg,celBg,title}) => {
    return (
        ...
        <span className={` ${datBg} flex items-center justify-center text-[14px] w-[20px] h-[20px] rounded-full absolute  right-2 top-[6px]`}>
          {num}
        </span>
        ...
        <div className="text-[10px] ss:mt-2 md:mt-0 sm:block hidden">
          <span className="hlg:text-[12px]  text-[10px]">3:25</span>
          <span className="md:mr-1">PM</span>
        </div>
      </div>
    );
}
